...
export function FourOhFour() {
    ...
    return <ErrorPage subtitle={`"${last}" is not a page on lytovka.com.`} title="Yikes, you hit that 404." />
}

export function ServerError({ title = "500. No bueno.", subtitle = "Please try refreshing the page." }: Partial<ErrorPageProps>) {
